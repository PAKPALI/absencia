                ...
                <div class="card card-primary">
                    ...
                    <form id="add">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputText0">Code client</label>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form class="update">
                                            ...
                                            <input type="hidden" value="{{$c -> code}}" name="code">
...
$(function() {
    ...
    document.querySelectorAll('.update').forEach(_formNode => {
        ...
        _formNode.addEventListener('submit', _event => {
            ...
            document.getElementById("Code").value = FormCode;

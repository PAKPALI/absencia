 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
   ...
   <a href="#" class="brand-link">
     <img src="{{asset('img/trimax.gif')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: 1" height="100" width="100">
   ...
   <div class="sidebar">
     ...
     <nav class="mt-2">
       <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         @if( Route::currentRouteName() == "dashboardProf")
         <li class="nav-item menu">
           <a href="{{route('dashboardProf')}}" class="nav-link active">
         ...
         @else
         <li class="nav-item menu">
           <a href="{{route('dashboardProf')}}" class="nav-link">
             <i class="nav-icon fas fa-tachometer-alt"></i>
             <p>
               Tableau de bord
             </p>
